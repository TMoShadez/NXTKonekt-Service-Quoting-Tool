      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Tabs defaultValue="partners" className="space-y-4">
                    ...
                    <TableBody>
                      {assessments?.slice(0, 10).map((assessment: any) => (
                        <TableRow key={assessment.id}>
                          ...
                          <TableCell className="capitalize">
                            <Badge variant="outline">
                              {assessment.serviceType?.replace('-', ' ') || 'N/A'}
                            </Badge>
                          </TableCell>
                          <TableCell>
                            <div>
                              <div className="font-medium">{assessment.customerName || 'N/A'}</div>
                              <div className="text-sm text-gray-500">{assessment.customerCompany || ''}</div>
                            </div>
                          </TableCell>
                          <TableCell>
                            <div>
          ...
          <TabsContent value="quotes" className="space-y-4">
            <Card>
              <CardHeader>
                <CardTitle>All Partner Quotes</CardTitle>
                <CardDescription>
                  Complete overview of quotes generated by all partners with detailed partner and customer information
                </CardDescription>
              </CardHeader>
              <CardContent>
                {quotesLoading ? (
                    ...
                    <TableBody>
                      {quotes?.slice(0, 10).map((quote: any) => (
                        <TableRow key={quote.id}>
                          ...
                          <TableCell>
                            <Badge variant="outline">
                              {quote.assessment?.serviceType?.replace('-', ' ') || 'N/A'}
                            </Badge>
                          </TableCell>
                          <TableCell>
                            <div>
                              <div className="font-medium">{quote.assessment?.customerName || 'N/A'}</div>
                              <div className="text-sm text-gray-500">{quote.assessment?.customerCompany || ''}</div>
                            </div>
                          </TableCell>
                          <TableCell>
                            <div>
                          ...
                          <TableCell>
                            {quote.organization?.name || 'N/A'}
                          </TableCell>
                          <TableCell className="font-medium">${quote.totalCost?.toLocaleString()}</TableCell>
                          <TableCell>
